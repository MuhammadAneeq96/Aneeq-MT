...
public class VerifyCEVersionID implements ICustomWorkflowCondition<IWorkflowObject> {
	
	//static final String CONDITION_NAME = Literals.WORKFLOW_PREFIX.getValue() + VerifyCEVersionID.class.getSimpleName();

	IWorkflowObject currentWorkItem; // gets the current work item (CE)
	...
	IWorkflowObject retrievedWorkItem;
	IModule retrievedCD;
	...
	@Override
	public String checkCondition(ICallContext<IWorkflowObject> context) {
